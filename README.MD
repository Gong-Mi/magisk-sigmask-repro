> Gong-Mi's source-and-verification workbench, not an official Magisk release.
> Official tree/history are preserved. See [SU validation](docs/su-validation.md)
> for pinned baselines, regression/ablation tests, fixes and unverified boundaries.
